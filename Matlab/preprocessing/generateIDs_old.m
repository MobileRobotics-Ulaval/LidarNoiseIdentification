...
%---------------------------------
% White Board
urg.indoor.board.plateIDs = [0, 1, 2, 3, 4, 5];
...
%---------------------------------
% Alu
urg.indoor.alu.plateIDs = [21, 22, 23, 24, 25, 26];
...
%---------------------------------
% Steel
urg.indoor.steel.plateIDs =  [42, 43, 44, 45, 46, 47];
...
%---------------------------------
% Iron
urg.indoor.iron.plateIDs =  [63, 64, 65, 66, 67, 68];
...
%---------------------------------
% White Board
utm.indoor.board.plateIDs = [153, 154, 155, 156, 157, 158];
...
%---------------------------------
% Alu
utm.indoor.alu.plateIDs = [132, 133, 134, 135, 136, 137];
...
%---------------------------------
% Steel
utm.indoor.steel.plateIDs = [111, 112, 113, 114, 115, 116];
...
%---------------------------------
% Iron
utm.indoor.iron.plateIDs = [63, 64, 65, 66, 67, 68];
...
%---------------------------------
% White Board
utm.outdoor.board.plateIDs = [0, 1, 2, 3, 4, 5];
...
%---------------------------------
% Alu
utm.outdoor.alu.plateIDs = [21, 22, 23, 24, 25, 26];
...
%---------------------------------
% Steel
utm.outdoor.steel.plateIDs = [42, 43, 44, 45, 46, 47];
...
%---------------------------------
% Iron
utm.outdoor.iron.plateIDs = [63, 64, 65, 66, 67, 68];
...
%---------------------------------
% White Board
lms.outdoor.board.plateIDs = [143, 144, 145, 146, 147, 148];
...
%---------------------------------
% Alu
lms.outdoor.alu.plateIDs = [179, 180, 181, 182, 183, 184];
...
%---------------------------------
% Steel
lms.outdoor.steel.plateIDs = [200, 201, 202, 203, 204, 205];
...
%---------------------------------
% Iron
lms.outdoor.iron.plateIDs = [221, 222, 223, 224, 225, 226];
